...
.. code-block::
  ...
  -v $PWD/bin/data/clients/4:/var/data \
  -e ENTRYPOINT_OPTS=--data_path=/var/data/IOT_normal_base.pt \
  --network=fedn_default \
  ghcr.io/scaleoutsystems/fedn/fedn:master-mnist-pytorch run client -in client.yaml --name client4
...
In a separate terminal, start a second client using the data partition 'data/clients/2/IOT_normal_base.csv':
